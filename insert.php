...
<form method="post" action="">
    <b>
        ...
        <br><br>
        <label for="2024-25">2024-25 Salary</label>
        <br>
	    <input type="text" id="2024-25" name="2024-25">

        <br><br>
        <label for="2025-26">2024-25 Salary</label>
        <br>
	    <input type="text" id="2025-26" name="2025-26">

        <br><br>
        <label for="2026-27">2024-25 Salary</label>
        <br>
	    <input type="text" id="2026-27" name="2026-27">

        <br><br>
        <label for="2027-28">2024-25 Salary</label>
        <br>
	    <input type="text" id="2027-28" name="2027-28">

        <br><br>
        <label for="2028-29">2024-25 Salary</label>
        <br>
	    <input type="text" id="2028-29" name="2028-29">

        <br><br>
        <label for="2029-30">2024-25 Salary</label>
        <br>
